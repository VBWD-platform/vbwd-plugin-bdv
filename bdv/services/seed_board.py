...
def seed_squares() -> List[Dict]:
    ...
    return [
        ...
        _deal(
            1, "Cold List", STAGE_LEAD_GEN, 600, [20, 100, 300, 900, 1600, 2500], 500
        ),
        ...
        _deal(
            ...
            STAGE_LEAD_GEN,
            600,
            [40, 200, 600, 1800, 3200, 4500],
            500,
        ),
        _plain(4, "tax", "Payroll Tax", tax_amount=2000),
        _service(5, "CRM Platform", 2000, [250, 500, 1000, 2000]),
        _deal(
            6, "Cold Email", STAGE_OUTREACH, 1000, [60, 300, 900, 2700, 4000, 5500], 500
        ),
        ...
        _deal(
            ...
            STAGE_QUALIFICATION,
            1600,
            [120, 600, 1800, 5000, 7000, 9000],
            1000,
        ),
        _service(15, "Ad Network", 2000, [250, 500, 1000, 2000]),
        _deal(
            16, "Demo Day", STAGE_PITCH, 1800, [140, 700, 2000, 5500, 7500, 9500], 1000
        ),
        ...
        _deal(
            ...
            STAGE_CONTRACT,
            2800,
            [240, 1200, 3600, 8500, 10250, 12000],
            1500,
        ),
        ...
        _deal(
            ...
            STAGE_DELIVERY,
            3000,
            [260, 1300, 3900, 9000, 11000, 12750],
            2000,
        ),
        _deal(
            32,
        ...
        _deal(
            ...
            STAGE_DELIVERY,
            3200,
            [280, 1500, 4500, 10000, 12000, 14000],
            2000,
        ),
        ...
        _deal(
            ...
            STAGE_EXPANSION,
            3500,
            [350, 1750, 5000, 11000, 13000, 15000],
            2000,
        ),
...
def seed_cards() -> List[Dict]:
    ...
    return [
        ...
        },
        {
            ...
            "effect": {"ops": [{"op": "move_to_square", "params": {"index": 0}}]},
            "sort_order": 3,
        },
        {
            "deck": "chance",
